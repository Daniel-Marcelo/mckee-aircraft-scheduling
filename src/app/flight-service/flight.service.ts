...
export class FlightService {
  ...
  constructor(private http: HttpClient, private messageService: MessageService, private rotationService: FlightRotationService) {
  ...
  getFlights(offset = 0, limit = 25): Observable<GetFlightsResponse> {
    return this.http.get<GetFlightsResponse>(flightsUrl(offset, limit)).pipe(
    ...
    handleSuccess(flightsResponse: GetFlightsResponse, rotationFlights: Flight[], offset: number) {
      ...
      flightsResponse.pagination.total = 200;
